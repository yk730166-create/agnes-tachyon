...
The current version is **6.6.3**. It supports 64-bit Windows 10 version 1809 or
...
Every desktop answer now uses Fish Audio S2.1 Pro Free. Options includes two
reviewed public Agnes performances: **Agnes — Classic**
(`64e74b61065540f4abed3a0f30cf14d9`) and **Agnes — Bright**
(`e34bac0a56564919ae6be88f5c80bfe5`). The app does not silently
